...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            var darkTheme by remember { mutableStateOf(false) } //deactivate the darkTheme until the logic is implemented

            DisposableEffect(darkTheme, uiState) {
                enableEdgeToEdge(
            ...
            PokedexTheme(
                ...
                IconButton(onClick = { darkTheme = !darkTheme }) {
                   Icon(if(darkTheme) Icons.Default.DarkMode else Icons.Default.LightMode, contentDescription = "Switch Theme")
                }
            }
        }
    }
